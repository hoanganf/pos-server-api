	...
	class RestaurantProductResponseBuilder implements ResponseBuilder{
		public function build($request){
			...
			if(isset($_GET['productId']) && is_numeric($_GET['productId'])){
				...
				else return ServerApiResponseGetter::createResponse('false',E_NO_RESTAURANT,'NO RESTAURANT');
			...
			else return ServerApiResponseGetter::createResponse('false',E_BAD_REQUEST,'BAD REQUEST');
		}
	}
?>
